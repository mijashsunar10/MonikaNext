...
export default function FeaturedShowcase() {
  ...
  return (
    <section className="relative w-full bg-[#07070d] py-20 text-white overflow-hidden border-t border-white/5">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-24 pt-16 border-t border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            {/* STEP 1 */}
            <div className="glass-card rounded-3xl p-8 relative border border-white/5 space-y-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-orange-500/10 text-orange-500 border border-orange-500/20 font-heading text-xl font-bold">
                1
              </div>
              <h4 className="font-heading text-xl font-bold text-white">Select Your Tyre</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
                Use our interactive tyre finder tool or browse our catalog by brand, size, or vehicle category.
              </p>
            </div>

            {/* STEP 2 */}
            <div className="glass-card rounded-3xl p-8 relative border border-white/5 space-y-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-amber-500/10 text-amber-500 border border-amber-500/20 font-heading text-xl font-bold">
                2
              </div>
              <h4 className="font-heading text-xl font-bold text-white">Get Wholesale Quote</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
                Submit an instant quote form or contact our Balaju/Teku hotline for customized pricing and bulk freight details.
              </p>
            </div>
            ...
            <div className="glass-card rounded-3xl p-8 relative border border-white/5 space-y-4">
              ...
              <h4 className="font-heading text-xl font-bold text-white">Free Fitting or Delivery</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
                Visit our state-of-the-art Kathmandu workshops for free expert fitting and 3D wheel balancing, or enjoy express freight shipping.
              </p>
            </div>
